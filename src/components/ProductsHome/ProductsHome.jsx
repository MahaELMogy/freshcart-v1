...
export default function ProductsHome() {
  ...
  return (
    <section className="pb-8 px-4 sm:px-6 md:px-10 lg:px-16">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5">
        {data?.map((product) => (
          <div
            key={product._id}
            className="relative bg-white border border-gray-200 rounded-lg shadow hover:shadow-md transition-all duration-300 flex flex-col p-2"
          >
            {/* Wishlist Icon */}
            <div
            ...
            >
              <i
                className={`fa-solid fa-heart text-xl sm:text-2xl transition-transform duration-200 hover:scale-110 ${
